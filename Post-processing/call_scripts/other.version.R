...
cities=c("Atlanta", "Austin","Baltimore","Cleveland","Columbus","Dallas_FortWorth",
"Detroit","Houston","Indianapolis","NewYork","Philadelphia","Portland","SanDiego","Washington","Denver")
# cities=c("Orlando")
